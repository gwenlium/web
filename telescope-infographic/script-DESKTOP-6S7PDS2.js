...
if (modalContent && modalContent.closest('#modal')) { // Only add arrows to the main topic modal
  ...
  const quellen = [
    ...
    },
    {
      ...
      items: [
        ...
        'Portraits: https://astronomy.org/programs/planet-quiz-show/answers/57.html'
      ]
    }
  ];
